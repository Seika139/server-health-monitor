...
echo "  2. Validate:       bash $INSTALL_DIR/scripts/validate-config.sh"
echo "  3. Test alert:     bash $INSTALL_DIR/scripts/test-alert.sh"
echo "  4. Check status:   bash $INSTALL_DIR/scripts/status.sh"
echo "  5. Analyze logs:   bash $INSTALL_DIR/scripts/analyze.sh [YYYY-MM-DD]"
echo ""
